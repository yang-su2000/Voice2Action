...
IL_013b:
	{
		...
		Text_tD60B2346DAA6666BF0D822FF607F0B220C2B9E62* L_88 = __this->___m_ShowCursorValueText_31;
		...
		Text_tD60B2346DAA6666BF0D822FF607F0B220C2B9E62* L_95 = __this->___m_HeadsetLookButtonText_27;
		XRDeviceSimulator_t2BEF1AB226D797BE78F5B291FCCB8A8B4274B30C* L_96 = __this->___m_Simulator_4;
		NullCheck(L_96);
		int32_t L_97;
		L_97 = XRDeviceSimulator_get_mouseTransformationMode_m4B1DA38C4DDCC9785B3B219F9A550A98E7DECEA1_inline(L_96, NULL);
		G_B12_0 = L_95;
		if (!L_97)
		{
			G_B13_0 = L_95;
...
IL_025f:
	{
		...
		Text_tD60B2346DAA6666BF0D822FF607F0B220C2B9E62* L_98 = __this->___m_MouseModeValueText_33;
		XRDeviceSimulator_t2BEF1AB226D797BE78F5B291FCCB8A8B4274B30C* L_99 = __this->___m_Simulator_4;
		NullCheck(L_99);
		InputActionReference_t64730C6B41271E0983FC21BFB416169F5D6BC4A1* L_100;
		L_100 = XRDeviceSimulator_get_toggleMouseTransformationModeAction_m8E831EA2AF126773BC928B09F5684CCEDD595FB4_inline(L_99, NULL);
		NullCheck(L_100);
		...
		NullCheck(L_101);
		ReadOnlyArray_1_tA1DF7A256AD2BF17FB155224CB2611ED215EFCD3 L_102;
		L_102 = InputAction_get_controls_mC677AD1ABF680C5D2175E704FFAF0C6C3A86FE82(L_101, NULL);
		V_12 = L_102;
		InputControl_t74F06B623518F992BF8E38656A5E0857169E3E2E* L_103;
		L_103 = ReadOnlyArray_1_get_Item_mF7217A9697E8EAA3A574FCDCB611597EC9C1836A((&V_12), 0, ReadOnlyArray_1_get_Item_mF7217A9697E8EAA3A574FCDCB611597EC9C1836A_RuntimeMethod_var);
		NullCheck(L_103);
		String_t* L_104;
		L_104 = InputControl_get_displayName_m9F6CBDDD6B25EC0E25BEE1DD51105667F0BA9A23(L_103, NULL);
		NullCheck(L_98);
		VirtualActionInvoker1< String_t* >::Invoke(75 /* System.Void UnityEngine.UI.Text::set_text(System.String) */, L_98, L_104);
		// m_ShowCursorButton.color = Cursor.lockState == CursorLockMode.Locked ? selectedColor : buttonColor;
		Image_tBC1D03F63BF71132E9A5E472B8742F172A011E7E* L_105 = __this->___m_ShowCursorButton_30;
		int32_t L_106;
		L_106 = Cursor_get_lockState_m99E97A23A051AA1167B9C49C3F6E8244E74531AE(NULL);
		G_B15_0 = L_105;
	...
	}
	{
		...
		L_107 = XRDeviceSimulatorUI_get_buttonColor_m9AB451B5FA796E3E6FA1FD994567E972D15D06E9(__this, NULL);
		G_B17_0 = L_107;
		G_B17_1 = G_B15_0;
		goto IL_02b1;
	}
...
IL_02ab:
	{
		...
		L_108 = XRDeviceSimulatorUI_get_selectedColor_m1A0333F7892987F43D726871D74A1A979CF16F7E(__this, NULL);
		G_B17_0 = L_108;
		G_B17_1 = G_B16_0;
	}
