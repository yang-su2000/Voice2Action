...
{
    public static Dictionary<string, Color> m_ColorMap = new Dictionary<string, Color>
    {
        { "black", Color.black }, 
        { "blue", Color.blue }, 
        { "cyan", Color.cyan },
    ...
    // (x1, x2, z1, z2)
    public static Dictionary<string, (float, float, float, float)> m_AddressMap =
        new Dictionary<string, (float, float, float, float)>();

    public static Dictionary<string, Shapes> m_ShapesMap = new Dictionary<string, Shapes>
    {
        { "object", Shapes.Object },
    };

    public static Dictionary<string, Vector3> m_DirectionMap = new Dictionary<string, Vector3>
    {
        { "left", Vector3.left },
        { "right", Vector3.right },
        { "up", Vector3.up },
